...
from AnswerClariQ import AnswerGenDoubleHeadGPT2
...
def main(hparams):
    ...
    model = AnswerGenDoubleHeadGPT2(hparams)
    ...
    checkpoint_callback = ModelCheckpoint(
                ...
                filepath='/scratch/sekulic/checkpoints',
                save_top_k=1,
                verbose=True,
...
if __name__=='__main__':
    ...
    parser = argparse.ArgumentParser(description='CAsT')
    # MODEL SPECIFIC
    ...
    parser.add_argument('--test_ckp', type=str, default='/scratch/sekulic/checkpoints/answer_gen/epoch=9.ckpt')
    parser.add_argument('--use_faceted_data', type=int, default=0)
    parser.add_argument('--without_facets', type=int, default=0)
    parser.add_argument('--answer_generation', type=int, default=1)
    parser.add_argument('--my_faceted_data', type=str, default='../clustering/data/facet_kw_query_removed.tsv')
    ...
    parser.add_argument("--min_output_len", type=int, default=1, help="Minimum length of the output utterances")
    ...
    parser.add_argument("--val_data_loader_bs", type=int, default=1,
